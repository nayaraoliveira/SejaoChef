	...
	<div id="ttinicial">
		...
		<!--texto página inicial -->
			...
			<p><b>Nossa missão é fornecer sanduíches personalizados com sabor, qualidade e higiene. Aqui, 
		   		...
		   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Crie seu cardápio personalizado dando nome às suas obras de arte gastronômicas ou selecione uma de nossas sugestões, incrementando-a como quiser para proporcionar uma melhor experiência de sabor.<br><br>
		   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Não está achando o ingrediente certo para inebriar seu paladar? Mande sugestões de itens para abastecermos nossa despensa e aumentar o seu deleite criativo e suas opções de degustação.<br><br>
		   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Satisfaça seu desejo de criar e (Porque não?) comer bem, lembrando sempre que aqui, em nossa cozinha, nós queremos que você <i>Seja o Chef!</i></b></p>
	   		</div>
