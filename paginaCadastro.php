...
if($dado['cpf']==$cpf2 and $dado['senha']==$senha2 and $senha2!=null and $cpf2!= null){
	...
	header("Location:http://localhost/SejaoChef-master/paginaCardapio2.php?nome=".$dado['nome']);
...
}else{echo"Linha 1 não preenchida corretamente!";}
...
}else{echo"Linha 2 não preenchida corretamente!";}
